            ...
            return i(t, [{
                ...
                value: function() {
                    var e = o(n.mark((function e(r, o, a, i, c) {
                        var l, f, v, y, w, _, P, O, j, N, M, D, U, W, F, q, G, B, V, H, z, $, Q, X, Y, K, J, Z, tt, et, rt, nt, ot, at;
                        return n.wrap((function(e) {
                            for (; ; )
                                ...
                                case 46:
                                    ...
                                    e.abrupt("return", !1);
                                case 50:
                                    if (this.urlIsNew(w) || f || (r = "replaceState"),
                                    M = a,
                                    "/_error" !== (P = P ? (0,
                                    u.removePathTrailingSlash)(E(P)) : P) && (_.pathname = A(P, j),
                                    _.pathname !== P && (P = _.pathname,
                                    o = (0,
                                    h.formatWithValidation)(_))),
                                    D = (0,
                                    u.removePathTrailingSlash)(P),
                                    R(a)) {
                                        e.next = 60;
                                        break
                                    }
                                ...
                                case 60:
                                    ...
                                    throw new Error((G ? "The provided `href` (".concat(o, ") value is missing query values (").concat(V.join(", "), ") to be interpolated properly. ") : "The provided `as` value (".concat(W, ") is incompatible with the `href` value (").concat(D, "). ")) + "Read more: https://nextjs.org/docs/messages/".concat(G ? "href-interpolation-failed" : "incompatible-href-as"));
                                case 73:
                                    e.next = 76;
                                    break;
                                case 75:
                                ...
                                case 107:
                                    ...
                                    i._h && "/_error" === P && 500 === (null == (H = self.__NEXT_DATA__.props) || null == (z = H.pageProps) ? void 0 : z.statusCode) && null != Y && Y.pageProps && (Y.pageProps.statusCode = 500),
                                    e.next = 114,
                                    this.set(D, P, O, w, $, c || (at || !i.scroll ? null : {
                                        x: 0,
                                        y: 0
                                    })).catch((function(t) {
                                        if (!t.cancelled)
                                ...
                                case 114:
                                    ...
                                    throw t.events.emit("routeChangeError", X, w, y),
                                    X;
                                case 117:
                        ...
                        return n.wrap((function(t) {
                            for (; ; )
                                ...
                                case 12:
                                    ...
                                    l = f.__rewrites,
                                    p = (0,
                                    y.default)(k(b(r, this.locale)), c, l, a.query, (function(t) {
                                        return A(t, c)
                                    }
                                    ), this.locales),
